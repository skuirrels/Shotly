...
Three keys, and they work in any app:
...
| <kbd>I</kbd> Pick colour | <kbd>G</kbd> Grab text | <kbd>C</kbd> Crop | |
...
## Grabbing text out of a picture
...
You'll see what it found, so you can check it before pasting, and click any
single line to copy just that one.

This uses the text recognition built into macOS. Nothing is uploaded anywhere.
